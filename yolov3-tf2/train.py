...
from models import yolov3, yolov3_tiny, yolo_loss, yolo_anchors, yolo_anchor_masks, yolo_tiny_anchors, yolo_tiny_anchors_maks
...
def setup_model():
    if FLAGS.tiny:
        model = yolov3_tiny(FLAGS.size, training=True, classes=FLAGS.num_classes)
        anchors = yolo_tiny_anchors
        anchor_masks = yolo_tiny_anchors_masks
    else:
    ...
    if FLAGS.transfer == 'none':
        ...
        # reset top layers
        if FLAGS.tiny:
            model_pretrained = yolov3_tiny(FLAGS.size, training=True, classes=FLAGS.weights_num_classes or FLAGS.num_classes)
        else:
